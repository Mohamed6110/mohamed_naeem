...
export const ProjectCard: React.FC<ProjectCardProps> = ({ project }) => {
  return (
    <div className="bg-white dark:bg-slate-900/60 border border-slate-200 dark:border-slate-800 rounded-[2.5rem] p-10 hover:border-indigo-500/50 transition-all duration-700 flex flex-col group hover:-translate-y-3 hover:shadow-[0_40px_100px_rgba(79,70,229,0.15)] shadow-xl h-full">
